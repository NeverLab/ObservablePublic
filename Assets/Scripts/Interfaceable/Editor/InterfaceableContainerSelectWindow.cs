...
public class InterfaceableContainerSelectWindow : EditorWindow
{
    ...
    private InterfaceableContainerPropertyDrawer.SerializedContainer _serializedContainer;
    ...
    private void OnGUI()
    {
        ...
        _scrollPos = InterfaceableGUIHelper.ScrollViewBlock(_scrollPos, false, false, () =>
        {
    ...
    private GUIStyle GetNextStyle()
    {
        _switchBoxStyle = !_switchBoxStyle;
         return _switchBoxStyle ? InterfaceableGUIHelper.SelectWindowStyles.ObjectGroup : InterfaceableGUIHelper.SelectWindowStyles.ObjectGroupSwitch;
    }
    ...
    private class GUIObjectNodeHelper
    {
        ...
        private readonly InterfaceableContainerPropertyDrawer.SerializedContainer _serializedContainer;
        ...
        private void ExecuteActions()
        {
            ...
            if(_ping)
            {
                InterfaceableGUIHelper.PingObject(_objectNode.Object);
            }
        }
        ...
        private GUIStyle DetermineObjectStyle(GUIStyle defaultStyle, ObjectNode objectNode, Object selectedObject)
        {
            if(_ping || _pingDown)
            {
                return InterfaceableGUIHelper.SelectWindowStyles.Pinged;
            }

            if(selectedObject == objectNode.Object || _select || _selectDown)
            {
                return InterfaceableGUIHelper.SelectWindowStyles.SelectedObject;
            }
