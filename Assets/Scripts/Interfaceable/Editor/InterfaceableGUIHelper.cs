...
namespace NeverLab.Interfaceable.Editor
{
    public class InterfaceableGUIHelper : ScriptableObject
    {
        public static InterfaceableGUIHelper Instance
        {
            get
            {
                if(_instance == null)
                {
                    var instances = Resources.FindObjectsOfTypeAll<InterfaceableGUIHelper>().ToList();
                    ...
                    {
                        _instance = CreateInstance<InterfaceableGUIHelper>();
                    }
                }
        ...
        private static InterfaceableGUIHelper _instance;
        ...
        private const string GUITextureName = "InterfaceableGUITexture";
        ...
        public static string GetObjectName(Object @object)
        {
            ...
            {
                return NeverLab.Interfaceable.InterfaceableContainerBase.ConstructResolvedName(@object.GetType());
            }
        ...
        private static readonly List<FieldInfo> TextureFields = CachedType<InterfaceableGUIHelper>.Type.GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)
