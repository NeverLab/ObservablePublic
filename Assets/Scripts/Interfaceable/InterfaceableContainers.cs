...
using System.Linq;
using NeverLab.Interfaceable;

public class InterfaceableContainers<TContainer, TInterface> : IList<TInterface>
    where TInterface : class
    where TContainer : InterfaceableContainer<TInterface>, new()
{
    private readonly Func<IList<TContainer>> _getList;

    public InterfaceableContainers(Func<IList<TContainer>> getList)
    {
        _getList = getList;
    }
